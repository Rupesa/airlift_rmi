...
public class SimulationParameters {
    ...
    /**
     * General Repository name entry for the register.
     */
    public final static String REPOS_NAME_ENTRY = "GeneralReposHandler";
    ...
    /**
     * Departure Airport name entry for the register.
     */
    public final static String DEPARTURE_AIRPORT_NAME_ENTRY = "DepartureAirportHandler";
    ...
    /**
     * Destination Airport name entry for the register.
     */
    ...
    /**
     * Plane name entry for the register.
     */
     ...
     */
    public final static int SERVER_REGISTRY_PORT = 8085;
     ...
     * Server registry server port.
     */
    public final static int REGISTRY_PORT = 8086;
...
//     * Server registry server port.
//     */
//    public final static int SERVER_REGISTRY_PORT = 22454;
//
//    /**
//     * Server registry host name.
//     */
//    public final static String REGISTRY_HOST_NAME = "l040101-ws09.ua.pt";
//
//    /**
//     * Server registry server port.
//     */
//    public final static int REGISTRY_PORT = 22455;
//
//    /**
//     * Registry name entry for the register.
//     */
