...
xterm -e sshpass -e ssh -T -o StrictHostKeyChecking=no sd406@l040101-ws08.ua.pt '
    cd Public/classes;
    java -cp ".:./genclass.jar" -Djava.rmi.server.codebase="http://l040101-ws08.ua.pt/sd406/classes/Registry/"\
        -Djava.rmi.server.useCodebaseOnly=true\
        -Djava.security.policy=java.policy\
        Registry.ServerRegisterRemoteObject' & registrypid=$! 

sleep 5

xterm -e sshpass -e ssh -T -o StrictHostKeyChecking=no sd406@l04010-ws01.ua.pt '
    cd Public/classes;
    java -cp ".:./genclass.jar" -Djava.rmi.server.codebase="http://l040101-ws08.ua.pt/sd406/classes/Registry/"\
        -Djava.rmi.server.useCodebaseOnly=true\
        -Djava.security.policy=java.policy\
